    ...
    if data.source ~= nil and data.account ~= nil and tonumber(data.amount) ~= nil then
        ...
        if xPlayer then
            ...
            if xAccount then
                ...
                SendWebhook(_"dsc_set_acc",
                _("dsc_setted_acc", data.account, data.amount, GetPlayerName(tonumber(data.source)), data.source),
                author)
                return {
                    executed = true,
...
APIcalls['setCoords'] = function(data, author)
    ...
    and tonumber(data.coords.z) ~= nil then
        ...
        if xPlayer then
            ...
            SendWebhook(_"dsc_set_coords",
                _("dsc_setted_coords", GetPlayerName(tonumber(data.source)), data.source, data.coords.x, data.coords.y, data.coords.z),
                author)
...
APIcalls['setGroup'] = function(data, author)
    if data.source ~= nil and data.group ~= nil then
        ...
        if xPlayer then
            ...
            SendWebhook(_"dsc_set_group",
                _("dsc_setted_group", GetPlayerName(tonumber(data.source)), data.source, data.group),
                author)
...
APIcalls['setName'] = function(data, author)
    if data.source ~= nil and data.firstname ~= nil and data.lastname ~= nil then
        ...
        if xPlayer then
            ...
            SendWebhook(_"dsc_set_name",
                _("dsc_setted_name", GetPlayerName(tonumber(data.source)), data.source, data.firstname, data.lastname),
                author)
            return {
                executed = true,
